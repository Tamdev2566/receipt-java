...
public class EdiToCodaService {
  ...
  public List<EdiToCoda> retrieveReceipts(
    LocalDate fromDate,
    LocalDate toDate,
    String locationId
  ) {
    ...
    return jdbcTemplate.query(
      ...
      (rs, rowNum) -> {
        ...
        dto.setCurrency(
          rs.getString("currency") != null ? rs.getString("currency") : ""
        );
  ...
  @Transactional
  public String exportEdiReceipts(
    LocalDate fromDate,
    LocalDate toDate,
    String locationId
  ) {
    ...
    String fetchSql =
      "SELECT transaction_no, receipt_date, currency_code AS currency FROM receipt " +
    ...
    return (
      "Successfully exported " + updatedRows + " receipt record(s) to CODA."
    );
  }
