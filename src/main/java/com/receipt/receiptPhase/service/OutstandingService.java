...
public class OutstandingService {
  ...
  public List<Map<String, Object>> getOutstandingData(
    OutstandingRequest request
  ) {
    if (
      request.getCustomerNames() == null || request.getCustomerNames().isEmpty()
    ) {
    ...
    String query =
      "SELECT bl_no, vessel_code, vessel_name, voyage_no, customer_name, type, reference_date, reference_no, " +
    ...
    if ("DocSys".equalsIgnoreCase(requestSource)) {
      ...
      "Glossys".equalsIgnoreCase(requestSource) ||
      "Glosys".equalsIgnoreCase(requestSource)
    ) {
