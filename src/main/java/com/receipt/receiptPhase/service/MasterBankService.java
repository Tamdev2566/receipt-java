...
public class MasterBankService {
    ...
    public String updateBank(String bankId, MasterBankModel bank, String locationId) {
        bank.setOfficeCode(requiredLocation(locationId));
    ...
    public String deleteBank(String bankId, String userId, String locationId) {
        ...
        int result = repository.delete(bankId, userId, currentDateTime, requiredLocation(locationId));
