...
public class DailyScanReportService {
  ...
  public List<DailyScanReport> getDailyScanReport(
    LocalDate fromDate,
    LocalDate toDate,
    String bound
  ) {
    ...
    return jdbcTemplate.query(
      ...
      (rs, rowNum) -> {
        ...
        dto.setCreateTime(
          rs.getString("create_time") != null ? rs.getString("create_time") : ""
        );
  ...
  public ByteArrayInputStream generateCsvReport(
    ...
    writer.println(
      "BOUND,FULL CHEQUE NO,CHEQUE NO,BANK NAME,USER ID,CREATE TIME,AUTO READ"
    );
