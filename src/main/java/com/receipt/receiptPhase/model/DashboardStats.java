...
public class DashboardStats {
  ...
  public DashboardStats(
    long totalReceipts,
    long activeReceipts,
    long undoVerifiedReceipts,
    long removedReceipts,
    double totalAmount
  ) {
  ...
  public long getActiveReceipts() {
    return activeReceipts;
  }

  public long getUndoVerifiedReceipts() {
    return undoVerifiedReceipts;
  }

  public long getRemovedReceipts() {
