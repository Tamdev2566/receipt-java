...
public class ChequeController {
  ...
  @PostMapping("/save")
  public ResponseEntity<Map<String, Object>> saveCheque(
  ...
  public ResponseEntity<Map<String, Object>> updateCheque(
    @RequestBody ChequeReaderModel request
  ) {
    Map<String, Object> response = new HashMap<>();
    try {
  ...
  @PostMapping("/list")
  public ResponseEntity<Map<String, Object>> getChequesList(
    @RequestBody(required = false) Map<String, String> requestData
  ) {
    Map<String, Object> response = new HashMap<>();
    try {
      String uid = (requestData != null) ? requestData.get("uid") : null;
      String locationId = (requestData != null)
        ? requestData.get("locationId")
        : null;
      List<ChequeReaderModel> list = chequeService.getChequeList(
        uid,
        locationId
      );
