...
public class UpdatedChequeReportController {
  ...
  public ResponseEntity<List<UpdatedChequeReport>> getReportData(
    ...
    List<UpdatedChequeReport> data =
      updatedChequeReportService.getUpdatedChequeReport(fromDate, toDate);
  ...
  public ResponseEntity<InputStreamResource> downloadCsv(
    ...
    ByteArrayInputStream in = updatedChequeReportService.generateCsvReport(
      fromDate,
      toDate
    );
