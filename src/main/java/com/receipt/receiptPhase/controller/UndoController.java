...
public class UndoController {
  ...
  public ResponseEntity<Object> retrieveRecords(
    ...
    if (
      ...
      badRequest.put(
        "message",
        "Please Enter Invoice No or BL No or Cheque No."
      );
      return ResponseEntity.badRequest().body(badRequest);
    }

    UndoRequest data = undoService.retrieveRecords(
      invoiceNo,
      chequeNo,
      blNo,
      locationId
  ...
  public ResponseEntity<Map<String, String>> executeUndo(
    @RequestBody List<String> selectedTransactionNos,
    @RequestParam String locationId
  ) {
